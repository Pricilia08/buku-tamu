...
<td> : <input name='nm_galeri' type='text' size='35' /></td></tr>
...
<input type=hidden name='id_galeri' value='$r[id_galeri]'>
<table>
<tr><td>Nama Galeri</td>
<td> : <input name='nm_galeri' type='text' size='35' value='$r[nm_galeri]' /></td></tr>
<tr><td>File Gambar</td>
